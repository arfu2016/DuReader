...
@Desc      :
python work2/gensim_word2vec_chinese/train_word2vec_model.py
wiki-word2vec/data/wiki.zh.text.seg
wiki-word2vec/data/wiki.zh.model
wiki-word2vec/data/wiki.zh.vector
